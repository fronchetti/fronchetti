...
A great example of a project that I have been working on this year is <a href="https://youtu.be/MDmuNLtOmC4">Duplo<a>, a block-based programming language for two-armed robots that is designed for users without experience in programming. Most of my projects with robots are still a work-in-progress, but you can learn more about them <a href="https://se.lab.vcu.edu/demo/robotics/">here</a>.
